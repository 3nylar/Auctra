  ...
  return (
    <main className="flex-1 flex items-center justify-center gradient-trust px-6 py-16">
      <div className="w-full max-w-sm text-center">
        ...
        <div className="w-14 h-14 rounded-2xl bg-primary-soft text-primary-dark flex items-center justify-center mx-auto mb-6">
          <MailCheck size={26} />
        </div>
        ...
        <Link
          href="/login"
          className="inline-block mt-8 text-sm text-primary hover:text-primary-dark transition-colors"
        >
          ← Back to sign in
        </Link>
      </div>
