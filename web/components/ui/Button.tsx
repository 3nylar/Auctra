...
const variantClasses: Record<Variant, string> = {
  primary:
    "gradient-primary-btn text-[#141420] font-semibold shadow-soft hover:brightness-110 active:brightness-95 disabled:opacity-50 disabled:cursor-not-allowed",
  secondary:
    "bg-surface text-ink border border-line hover:border-gold/40 hover:bg-gold-soft disabled:opacity-50",
